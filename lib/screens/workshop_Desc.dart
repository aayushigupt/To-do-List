...
class Workshop_Desc extends StatefulWidget {
  final String title, description, date, time, imgURL;
  Workshop_Desc({this.title, this.description, this.date, this.time, this.imgURL});
  @override
  _Workshop_DescState createState() => _Workshop_DescState();
}

class _Workshop_DescState extends State<Workshop_Desc> {
                  ...
                  Container(
                    ...
                    child: RaisedButton(
                      onPressed: () async {
                        ...
                        await collectionRef.add(workshop);
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (BuildContext context) => Workshop_Listing(imageURL: dowurl),
                            ));
                      },
                      color: Colors.pink,
                      shape: RoundedRectangleBorder(
