...
class Trips_Desc extends StatefulWidget {
  final String title, description, date, time, imgURL;
  Trips_Desc({this.title, this.description, this.date, this.time, this.imgURL});
  @override
  _Trips_DescState createState() => _Trips_DescState();
}

class _Trips_DescState extends State<Trips_Desc> {
                  ...
                  Container(
                    ...
                    child: RaisedButton(
                      onPressed: () async {
                        ...
                        await collectionRef.add(trips);
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (BuildContext context) => Trips_Listing(imageURL: dowurl),
                            ));
                      },
                      color: Colors.indigo,
                      shape: RoundedRectangleBorder(
