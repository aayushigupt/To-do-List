...
class Tech_Desc extends StatefulWidget {
  final String title, description, date, time, imgURL;
  Tech_Desc({this.title, this.description, this.date, this.time, this.imgURL});
  @override
  _Tech_DescState createState() => _Tech_DescState();
}

class _Tech_DescState extends State<Tech_Desc> {
                  ...
                  Container(
                    ...
                    child: RaisedButton(
                      onPressed: () async {
                        uploadPic(context);
                        var collectionRef =
                            Firestore.instance.collection("technical");
                        Map<String, dynamic> tech = {
                          "title": titleController.text,
                          "description": descriptionController.text,
                         "imageURL" : dowurl,
                        };
                        await collectionRef.add(tech);
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (BuildContext context) => Tech_Listing(imageURL: dowurl),
                            ));
                      },
                      color: Colors.orange,
                      shape: RoundedRectangleBorder(
