...
class Sleep_Desc extends StatefulWidget {
  final String title, description, date, time, imgURL;
  Sleep_Desc({this.title, this.description, this.date, this.time, this.imgURL});
  @override
  _Sleep_DescState createState() => _Sleep_DescState();
}

class _Sleep_DescState extends State<Sleep_Desc> {
                  ...
                  Container(
                    ...
                    child: RaisedButton(
                      onPressed: () async {
                        uploadPic(context);
                        var collectionRef =
                            Firestore.instance.collection("sleep");
                        Map<String, dynamic> sleep = {
                          "title": titleController.text,
                          "description": descriptionController.text,
                          // "imageURL": downloadURL.toString(),
                        };
                        await collectionRef.add(sleep);
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (BuildContext context) => Sleep_Listing(imageURL: dowurl),
                            ));
                      },
                      color: Colors.grey,
                      shape: RoundedRectangleBorder(
