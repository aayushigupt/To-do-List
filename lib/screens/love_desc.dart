...
class Love_desc extends StatefulWidget {
  final String title, description, date, time, imgURL;
  Love_desc({this.title, this.description, this.date, this.time, this.imgURL});
  @override
  _Love_descState createState() => _Love_descState();
}

class _Love_descState extends State<Love_desc> {
                  ...
                  Container(
                    ...
                    child: RaisedButton(
                      onPressed: () async {
                        uploadPic(context);
                        var collectionRef =
                            Firestore.instance.collection("love");
                        Map<String, dynamic> love = {
                          "title": titleController.text,
                          "description": descriptionController.text,
                          // "imageURL": downloadURL.toString(),
                        };
                        await collectionRef.add(love);
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (BuildContext context) => Love_Listing(imageURL: dowurl),
                            ));
                      },
                      color: Colors.orange,
                      shape: RoundedRectangleBorder(
